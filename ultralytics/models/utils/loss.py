...
class DETRLoss(nn.Module):
    ...
    Attributes:
        ...
        fl (FocalLoss): Fallback classification loss for empty-target batches.
        vfl (VarifocalLoss): Classification loss used by the retained paper experiments.
    ...
    def _get_loss_class(self, pred_scores, targets, gt_scores, num_gts, postfix=''):
        ...
        loss_cls = (
            self.vfl(pred_scores, gt_scores, one_hot)
            if num_gts
            else self.fl(pred_scores, one_hot.float())
        )
