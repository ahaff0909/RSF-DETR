...
class DAVFL(SlideVarifocalLoss):
    """Difficulty-Aware Varifocal Loss, the thesis-facing alias of SlideVarifocalLoss."""


class EMADAVFL(EMASlideVarifocalLoss):
    """EMA-smoothed DAVFL variant kept for experiment compatibility."""
